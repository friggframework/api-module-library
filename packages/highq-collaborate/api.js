...
class Api extends OAuth2Requester {
    constructor(params) {
        super(params);
        this.baseUrl = 'https://api.highqsolutions.com';
        ...
        this.authorizationUri = 'https://api.highqsolutions.com/oauth/authorize';
        this.accessTokenUri = 'https://api.highqsolutions.com/oauth/token';
    }

    static Definition = {
        DISPLAY_NAME: 'HighQ Collaborate',
        MODULE_NAME: 'highq-collaborate',
