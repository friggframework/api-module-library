...
class Api extends OAuth2Requester {
    constructor(params) {
        super(params);
        this.baseUrl = 'https://driftapi.com';
        ...
        this.authorizationUri = encodeURI(
            `https://dev.drift.com/authorize?response_type=code&client_id=${this.client_id}&redirect_uri=${this.redirect_uri}&state=${this.state}&scope=${this.scope}`
        );
        this.tokenUri = 'https://driftapi.com/oauth2/token';
    ...
    // Add more API methods here specific to Drift
}
