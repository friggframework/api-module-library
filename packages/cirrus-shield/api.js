...
class Api extends OAuth2Requester {
    constructor(params) {
        super(params);
        this.baseUrl = 'https://api.cirrusshield.com';
        ...
        this.authorizationUri = 'https://api.cirrusshield.com/oauth/authorize';
        this.accessTokenUri = 'https://api.cirrusshield.com/oauth/token';
    }

    static Definition = {
        DISPLAY_NAME: 'Cirrus Shield',
        MODULE_NAME: 'cirrus-shield',
        CATEGORY: 'CRM',
        USES_OAUTH: true
    };
