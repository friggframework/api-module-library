...
class Api extends OAuth2Requester {
    constructor(params) {
        super(params);
        this.baseUrl = 'https://api.actsoft.com/v1';
        ...
        this.authorizationUri = encodeURI(
            `https://app.actsoft.com/oauth/authorize?response_type=code&client_id=${this.client_id}&redirect_uri=${this.redirect_uri}&state=${this.state}&scope=${this.scope}`
        );
        this.tokenUri = 'https://api.actsoft.com/oauth/token';
    ...
    // Add more API methods here specific to ActSoft
}
