...
class Api extends OAuth2Requester {
    constructor(params) {
        super(params);
        this.baseUrl = 'https://api.authorize.net';
        ...
        this.authorizationUri = 'https://api.authorize.net/oauth/authorize';
        this.accessTokenUri = 'https://api.authorize.net/oauth/token';
    }

    static Definition = {
        DISPLAY_NAME: 'Authorize.Net',
        MODULE_NAME: 'authorizenet',
        CATEGORY: 'Payment',
        USES_OAUTH: true
    };
