...
class Api extends OAuth2Requester {
    constructor(params) {
        ...
        this.authorizationUri = process.env.ENREACH_FORMERLY_HEROBASE_AUTH_URI;
        this.tokenUri = process.env.ENREACH_FORMERLY_HEROBASE_TOKEN_URI;
    }

    static Definition = {
        DISPLAY_NAME: 'Enreach (formerly Herobase)',
        MODULE_NAME: 'enreach-formerly-herobase',
        CATEGORY: 'https://api.enreachformerlyherobase.com',
        USES_OAUTH: true
    };
