...
class Api extends OAuth2Requester {
    constructor(params) {
        super(params);
        this.baseUrl = 'https://api.gathercontent.com';
        ...
        this.authorizationUri = 'https://api.gathercontent.com/oauth/authorize';
        this.accessTokenUri = 'https://api.gathercontent.com/oauth/token';
    }

    static Definition = {
        DISPLAY_NAME: 'GatherContent',
