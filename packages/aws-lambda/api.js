...
class Api extends OAuth2Requester {
    constructor(params) {
        super(params);
        this.baseUrl = 'https://lambda.amazonaws.com';
        ...
        this.authorizationUri = 'https://lambda.amazonaws.com/oauth/authorize';
        this.accessTokenUri = 'https://lambda.amazonaws.com/oauth/token';
    }
