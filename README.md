...
v1-ready
	...
	These modules are refactored and optimized to align with the new, simplified 
    architecture of Frigg v1. They are designed to be more intuitive, easier to 
    integrate, and provide better performance.
