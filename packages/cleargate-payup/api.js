...
class Api extends OAuth2Requester {
    constructor(params) {
        ...
        this.authorizationUri = process.env.CLEARGATE_PAYUP_AUTH_URI;
        this.tokenUri = process.env.CLEARGATE_PAYUP_TOKEN_URI;
    }

    static Definition = {
        DISPLAY_NAME: 'Cleargate PayUp',
        MODULE_NAME: 'cleargate-payup',
        CATEGORY: 'https://api.cleargatepayup.com',
        USES_OAUTH: true
    };
