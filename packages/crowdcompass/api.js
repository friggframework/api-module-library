...
class Api extends OAuth2Requester {
    constructor(params) {
        super(params);
        this.baseUrl = 'https://api.crowdcompass.com/v2';
        ...
        this.authorizationUri = encodeURI(
            `https://crowdcompass.com/oauth/authorize?response_type=code&client_id=${this.client_id}&redirect_uri=${this.redirect_uri}&state=${this.state}&scope=${this.scope}`
        );
        this.tokenUri = 'https://api.crowdcompass.com/oauth/token';
    ...
    // Add more API methods here specific to CrowdCompass
}
