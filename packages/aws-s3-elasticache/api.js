...
class Api extends OAuth2Requester {
    constructor(params) {
        ...
        this.authorizationUri = process.env.AWS_S3_ELASTICACHE_AUTH_URI;
        this.tokenUri = process.env.AWS_S3_ELASTICACHE_TOKEN_URI;
    }

    static Definition = {
        DISPLAY_NAME: 'AWS S3 Elasticache',
        MODULE_NAME: 'aws-s3-elasticache',
        CATEGORY: 'https://elasticache.amazonaws.com',
        USES_OAUTH: true
    };
