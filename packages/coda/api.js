...
class Api extends OAuth2Requester {
    constructor(params) {
        ...
        this.authorizationUri = encodeURI(
            `https://coda.io/oauth/authorize?response_type=code&client_id=${this.client_id}&redirect_uri=${this.redirect_uri}&state=${this.state}&scope=${this.scope}`
        );
        this.tokenUri = 'https://coda.io/oauth/token';
    ...
    // Add more API methods here specific to Coda
}
