...
class Api extends OAuth2Requester {
    constructor(params) {
        ...
        this.authorizationUri = process.env.CUBEPASSES_AUTH_URI;
        this.tokenUri = process.env.CUBEPASSES_TOKEN_URI;
    }

    static Definition = {
        DISPLAY_NAME: 'CubePasses',
        MODULE_NAME: 'cubepasses',
        CATEGORY: 'https://api.cubepasses.com',
        USES_OAUTH: true
    };
