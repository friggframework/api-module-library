...
class Api extends OAuth2Requester {
    constructor(params) {
        ...
        this.authorizationUri = process.env.AWS_CLOUDWATCH_AUTH_URI;
        this.tokenUri = process.env.AWS_CLOUDWATCH_TOKEN_URI;
    }

    static Definition = {
        DISPLAY_NAME: 'AWS Cloudwatch',
        MODULE_NAME: 'aws-cloudwatch',
        CATEGORY: 'https://monitoring.amazonaws.com',
        USES_OAUTH: true
    };
