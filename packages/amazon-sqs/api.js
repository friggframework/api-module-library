...
class Api extends OAuth2Requester {
    constructor(params) {
        super(params);
        this.baseUrl = 'https://sqs.amazonaws.com';
        ...
        this.authorizationUri = 'https://sqs.amazonaws.com/oauth/authorize';
        this.accessTokenUri = 'https://sqs.amazonaws.com/oauth/token';
    }

    static Definition = {
        DISPLAY_NAME: 'Amazon SQS',
        MODULE_NAME: 'amazon-sqs',
        CATEGORY: 'Developer',
        USES_OAUTH: true
    };
