...
class Api extends OAuth2Requester {
    constructor(params) {
        super(params);
        this.baseUrl = 'https://api.boomset.com';
        ...
        this.authorizationUri = 'https://api.boomset.com/oauth/authorize';
        this.accessTokenUri = 'https://api.boomset.com/oauth/token';
    }

    static Definition = {
        DISPLAY_NAME: 'Boomset',
        MODULE_NAME: 'boomset',
        CATEGORY: 'Marketing',
        USES_OAUTH: true
    };
