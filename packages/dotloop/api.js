...
class Api extends OAuth2Requester {
    constructor(params) {
        super(params);
        this.baseUrl = 'https://api.dotloop.com';
        ...
        this.authorizationUri = 'https://api.dotloop.com/oauth/authorize';
        this.accessTokenUri = 'https://api.dotloop.com/oauth/token';
    }

    static Definition = {
        DISPLAY_NAME: 'Dotloop',
        MODULE_NAME: 'dotloop',
        CATEGORY: 'CRM',
        USES_OAUTH: true
    };
