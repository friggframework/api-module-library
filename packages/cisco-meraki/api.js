...
class Api extends OAuth2Requester {
    constructor(params) {
        super(params);
        this.baseUrl = 'https://api.meraki.com';
        ...
        this.authorizationUri = 'https://api.meraki.com/oauth/authorize';
        this.accessTokenUri = 'https://api.meraki.com/oauth/token';
    }

    static Definition = {
        DISPLAY_NAME: 'Cisco Meraki',
        MODULE_NAME: 'cisco-meraki',
        CATEGORY: 'Security',
        USES_OAUTH: true
    };
