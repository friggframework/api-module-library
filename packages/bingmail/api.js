...
class Api extends OAuth2Requester {
    constructor(params) {
        ...
        this.authorizationUri = process.env.BINGMAIL_AUTH_URI;
        this.tokenUri = process.env.BINGMAIL_TOKEN_URI;
    }

    static Definition = {
        DISPLAY_NAME: 'Bingmail',
        MODULE_NAME: 'bingmail',
        CATEGORY: 'https://api.bingmail.com',
        USES_OAUTH: true
    };
