...
class Api extends OAuth2Requester {
    constructor(params) {
        ...
        this.authorizationUri = process.env.CLOCKWORK_RECRUITING_AUTH_URI;
        this.tokenUri = process.env.CLOCKWORK_RECRUITING_TOKEN_URI;
    }

    static Definition = {
        DISPLAY_NAME: 'Clockwork Recruiting',
        MODULE_NAME: 'clockwork-recruiting',
        CATEGORY: 'https://api.clockworkrecruiting.com',
        USES_OAUTH: true
    };
