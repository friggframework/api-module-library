...
class Api extends OAuth2Requester {
    constructor(params) {
        ...
        this.authorizationUri = process.env.FORMSITE_AUTH_URI;
        this.tokenUri = process.env.FORMSITE_TOKEN_URI;
    }

    static Definition = {
        DISPLAY_NAME: 'Formsite',
        MODULE_NAME: 'formsite',
        CATEGORY: 'https://api.formsite.com',
        USES_OAUTH: true
    };
