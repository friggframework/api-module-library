...
class Api extends OAuth2Requester {
    constructor(params) {
        ...
        this.authorizationUri = process.env.AMAZON_API_GATEWAY_AUTH_URI;
        this.tokenUri = process.env.AMAZON_API_GATEWAY_TOKEN_URI;
    }

    static Definition = {
        DISPLAY_NAME: 'Amazon API Gateway',
        MODULE_NAME: 'amazon-api-gateway',
        CATEGORY: 'https://apigateway.amazonaws.com',
        USES_OAUTH: true
    };
