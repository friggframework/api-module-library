...
class Api extends OAuth2Requester {
    constructor(params) {
        ...
        this.authorizationUri = encodeURI(
            `https://webexapis.com/v1/authorize?response_type=code&client_id=${this.client_id}&redirect_uri=${this.redirect_uri}&state=${this.state}&scope=${this.scope}`
        );
        this.tokenUri = 'https://webexapis.com/v1/access_token';
    ...
    // Add more API methods here specific to Cisco Webex
}
