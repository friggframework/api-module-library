...
class Api extends OAuth2Requester {
    constructor(params) {
        super(params);
        this.baseUrl = 'https://api.dispatch.me';
        ...
        this.authorizationUri = 'https://api.dispatch.me/oauth/authorize';
        this.accessTokenUri = 'https://api.dispatch.me/oauth/token';
    }

    static Definition = {
        DISPLAY_NAME: 'Dispatch.me',
        MODULE_NAME: 'dispatchme',
