...
class Api extends OAuth2Requester {
    constructor(params) {
        ...
        this.authorizationUri = process.env.AIRSTORY_AUTH_URI;
        this.tokenUri = process.env.AIRSTORY_TOKEN_URI;
    }

    static Definition = {
        DISPLAY_NAME: 'Airstory',
        MODULE_NAME: 'airstory',
        CATEGORY: 'https://api.airstory.com',
        USES_OAUTH: true
    };
