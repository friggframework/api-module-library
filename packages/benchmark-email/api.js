...
class Api extends OAuth2Requester {
    constructor(params) {
        ...
        this.authorizationUri = encodeURI(
            `https://ui.benchmarkemail.com/OAuth/Authorize?response_type=code&client_id=${this.client_id}&redirect_uri=${this.redirect_uri}&state=${this.state}&scope=${this.scope}`
        );
        this.tokenUri = 'https://clientapi.benchmarkemail.com/OAuth/Token';
    ...
    // Add more API methods here specific to Benchmark Email
}
