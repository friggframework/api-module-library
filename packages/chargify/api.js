...
class Api extends OAuth2Requester {
    constructor(params) {
        super(params);
        this.baseUrl = 'https://api.chargify.com/api/v2';
        ...
        this.authorizationUri = encodeURI(
            `https://app.chargify.com/oauth/authorize?response_type=code&client_id=${this.client_id}&redirect_uri=${this.redirect_uri}&state=${this.state}&scope=${this.scope}`
        );
        this.tokenUri = 'https://api.chargify.com/oauth/token';
    ...
    // Add more API methods here specific to Chargify
}
