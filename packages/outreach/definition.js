const { IntegrationBase, ModuleConstants, flushDebugLog, debug } = require('@friggframework/core');
...
class OutreachIntegration extends IntegrationBase {
    static Definition = {
        name: Config.name,
        version: '1.0.0',
    ...
    async findOrCreateEntity(params) {
        const org_uuid = _.get(params, 'org_uuid');
        const org_name = _.get(params, 'org_name');
